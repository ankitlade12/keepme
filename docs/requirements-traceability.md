...
|---|---|---|---|
| Person and garment intake | Implemented | [`StudioApp.tsx`](../components/StudioApp.tsx), [`upload-security.ts`](../lib/upload-security.ts), [`upload-security.test.ts`](../lib/upload-security.test.ts), and [`services/malware-scanner`](../services/malware-scanner/) implement catalog selection, JPEG/PNG validation, 10 MB/24 MP bounds, metadata stripping, safe reconstruction, and authenticated ClamAV scanning | Complete adversarial parser, scanner-outage, and antivirus-signature update testing |
