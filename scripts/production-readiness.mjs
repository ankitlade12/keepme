const required = ["DATABASE_URL", "BLOB_READ_WRITE_TOKEN", "CLERK_SECRET_KEY", "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY", "RETAILER_EMAIL_ALLOWLIST", "RECEIPT_SIGNING_SECRET", "CRON_SECRET", "MALWARE_SCAN_URL", "MALWARE_SCAN_TOKEN", "INTEGRITY_WORKER_TOKEN", "YOUCAM_API_KEY", "NEXT_PUBLIC_SITE_URL"];
