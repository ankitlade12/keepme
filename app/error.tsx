...
export default function ErrorPage({ retry }: { error: Error & { digest?: string }; retry: () => void }) {
  return (
    <main className="deletion-panel" style={{ minHeight: "100vh", display: "grid", placeContent: "center" }}>
      ...
      <div className="studio-actions" style={{ justifyContent: "center" }}><Link className="btn btn-secondary" href="/">Return home</Link><button className="btn btn-primary" onClick={() => retry()}>Try again</button></div>
    </main>
  );
}
